...
KNOWN_GAPS = (
    ...
    ("a bookmark record and its record_subjects row", "no bookmark record URI, so the selection names the post"),
    ("cid of a like", "post.likeUri has no CID column beside it, unlike post.repostCid"),
